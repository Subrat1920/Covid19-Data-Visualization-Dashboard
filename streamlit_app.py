...
st.subheader("Choropleth Maps")
st.plotly_chart(choropleth1, key="choropleth1")
st.plotly_chart(choropleth2, key="choropleth2")
...
# st.image(f'data:image/png;base64,{wordcloud_img1}', use_column_width=True)
# st.image(f'data:image/png;base64,{wordcloud_img2}', use_column_width=True)
st.image(f'data:image/png;base64,{wordcloud_img1}', use_container_width=True)
st.image(f'data:image/png;base64,{wordcloud_img2}', use_container_width=True)
